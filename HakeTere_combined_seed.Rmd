...
schemes_all <- scheming_functionz(dmv, seedvector = a2[,1],
                                  ...
                                  nr=20) # i.e. 1 seed from 1 families in ALL pops (5 seeds total)
...
## resample to get allele info
resample <- resample_analysis_functionz(dmv, schemes_all_downsampled, 0.05, "all") %>% as.data.frame(.)
